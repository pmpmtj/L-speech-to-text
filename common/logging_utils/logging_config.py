...
- Platform-specific log locations (Windows: AppData\\Local, Linux/Mac: project root)
...
LOGGING_CONFIG = {
    ...
    "loggers": {
        # Hotkey detector logger
        "hotkey_detector": {
            "log_filename": "hotkey_detector.log",
            "console_output": True,
            "file_output": True
        },
        ...
        # Recorder CLI logger
        "record_cli": {
            "log_filename": "record_cli.log",
            "console_output": True,
            "file_output": True
        },
        # Audio transcriber logger
        "transcriber": {
            "log_filename": "transcriber.log",
            "console_output": True,
            "file_output": True
        },
        # Transcriber CLI logger
        "transcribe_cli": {
            "log_filename": "transcribe_cli.log",
            "console_output": True,
            "file_output": True
        },
        # Clipboard paste utility logger
        "paste_from_clipboard": {
            "log_filename": "paste_from_clipboard.log",
            "console_output": True,
            "file_output": True
        },
        # Dependency checker logger
        "dependency_checker": {
            "log_filename": "dependency_checker.log",
            "console_output": True,
            "file_output": True
        },
        # Main entry point logger
        "main": {
...
# DEFAULT SETTINGS
# ============================================================================
DEFAULT_LOG_DIR = "logs"  # Default log directory (relative to SCRIPT_DIR for non-Windows)
DEFAULT_LOG_FORMAT = "%(asctime)s - %(name)s - %(levelname)s - %(message)s"
DEFAULT_DATE_FORMAT = "%Y-%m-%d %H:%M:%S"
APP_NAME = "L-speech-to-text"  # Application name for AppData subfolder
...
def determine_log_dir(base_dir: Optional[Path] = None) -> Path:
    ...
    On Windows, uses AppData\\Local\\APP_NAME\\logs
    On Linux/Mac, uses project root/logs (fallback behavior)
    
    Args:
        base_dir (Optional[Path]): Base directory for logging. 
                                 If None, uses platform-specific default:
                                 - Windows: AppData\\Local\\APP_NAME\\logs
                                 - Linux/Mac: project_root/logs
    ...
    # Windows: Use AppData\Local\APP_NAME\logs
    if os.name == 'nt':  # Windows
        ...
        if localappdata:
            ...
            from common.utils.file_sys_utils import get_project_root
            return get_project_root() / DEFAULT_LOG_DIR
    
    # Linux/Mac: Use project root/logs
    from common.utils.file_sys_utils import get_project_root
    return get_project_root() / DEFAULT_LOG_DIR
